...
import backgroundImage from "@/assets/images/jewel-model.jpeg"; // Import the image
...
const Form = () => {
  ...
  return (
    <div className="w-full h-screen flex">
      ...
      {/* Right Side - Form */}
      <div className="w-1/2 h-full bg-white/80 flex flex-col overflow-y-auto p-10">
        <Tabs defaultValue="single" className="w-full max-w-2xl mx-auto">
