...
//               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-black">Edit Roles</h2>
...
//             <div className="hidden md:block flex-1 overflow-auto w-full lg:w-3/4 xl:w-4/5 relative rounded-lg">
//         {/* Edit role card */}
...
//                         <div className="max-w-xs lg:max-w-sm truncate" title={item.email}>
//                           {item.email}
//                         </div>
//                       </td>
//                       <td className="px-3 lg:px-6 py-4 text-sm text-gray-500">
//                         <div className="max-w-xs truncate" title={item.phone}>
//                           {item.phone}
//                         </div>
//                       </td>
//                       <td className="px-5 lg:px-10 py-4 whitespace-nowrap  ">
//                         <button 
//                         onClick={()=>setEditRole(!editRole)}
//                         className=" h-full rounded-md cursor-pointer w-full text-center text-sm  bg-indigo-200 py-1 text-indigo-600">
//                             Change
//                         </button>
//                       </td>
//                     </tr>
